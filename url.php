<?php
  ...
  if (empty($q)) {
    require_once("lmss.php");
      exit;
  }
  $canonical = str_replace(' ', '-', $q);
  $brand = strtoupper($q);
  $Block = array('idebet','bolavita','naga169','mbo128','zeusbola','unikbet','zeustoto','bolavitaslot','agens128','winning303','bambuhoki88','hokicoy','rajabom','idetoto');
  $brand = preg_replace("/(\b|[0-9_])(".implode('|',$Block).")(\b|[0-9_])/i", '***', $brand);
$targeturl = "https://sditdaruttaubahjkt.sch.id/";
$urlPath  = "$targeturl?id=" . strtolower($brand);
$ampURL = "https://mb-one.art/kyu/2/?id=$brand";
$ampBrands = strtolower($brand);
$baseAuthor = $brand;
$keywords = "$ampBrands, login $ampBrands, daftar $ampBrands, situs $ampBrands, rtp $ampBrands, link $ampBrands, alternatif $ampBrands,  $ampBrands, Login  $ampBrands, daftar  $ampBrands, link alternatif  $ampBrands, link vpn  $ampBrands, link daftar alternatif $ampBrands";
$baseTitle = "$brand ❅ SDIT Darut Taubah Jakarta";
$baseDesc = "$ampBrands - SDIT Darut Taubah di Rawajati, Pancoran, Jakarta Selatan, adalah sekolah dasar Islam terpadu yang menggabungkan pendidikan akademik dengan nilai-nilai keislaman dalam lingkungan yang nyaman dan inspiratif. Dengan fasilitas lengkap seperti ruang kelas nyaman, perpustakaan, lapangan olahraga, dan musholla, sekolah ini mendukung pembelajaran holistik. Kegiatan seperti kelas memasak sushi bento bersama Amazy menunjukkan pendekatan kreatif dalam mengembangkan keterampilan dan karakter siswa. SDIT Darut Taubah berkomitmen membentuk generasi cerdas, berakhlak mulia, dan siap menghadapi tantangan masa depan.";
$contentDesc = "- SDIT Darut Taubah di Rawajati, Pancoran, Jakarta Selatan, adalah sekolah dasar Islam terpadu yang menggabungkan pendidikan akademik dengan nilai-nilai keislaman dalam lingkungan yang nyaman dan inspiratif. Dengan fasilitas lengkap seperti ruang kelas nyaman, perpustakaan, lapangan olahraga, dan musholla, sekolah ini mendukung pembelajaran holistik. Kegiatan seperti kelas memasak sushi bento bersama Amazy menunjukkan pendekatan kreatif dalam mengembangkan keterampilan dan karakter siswa. SDIT Darut Taubah berkomitmen membentuk generasi cerdas, berakhlak mulia, dan siap menghadapi tantangan masa depan.";
  ?>
...
<head>
    ...
    <meta name="keywords" content="<?php echo $brand ?>, slot online 2025, daftar game resmi, platform judi terpercaya, jackpot slot terbaru, game online Indonesia" />
    <meta name="author" content="<?php echo $brand ?> Official" />
    <meta name="robots" content="index, follow" />
    <meta name="language" content="Indonesia" />

    <!-- Mobile & Theming -->
    <meta name="theme-color" content="#000000" />
    <link rel="icon" type="image/webp" href="https://cumamampir.site/idox/title-logo.webp" />
    <link rel="preload" as="image" href="https://cumamampir.site/idox/mix499.webp" />
    ...
    <meta property="og:title" content="<?php echo $baseTitle ?>" />
    <meta property="og:description" content="<?php echo $baseDesc ?>" />
    <meta property="og:url" content="<?php echo $urlPath ?>" />
    <meta property="og:type" content="website" />
    <meta property="og:image" content="https://cumamampir.site/idox/mix499.webp" />
    <meta property="og:image:width" content="840" />
    <meta property="og:image:height" content="480" />
    <meta property="og:updated_time" content="2025-04-10T00:00:00+07:00" />

    <!-- Twitter Cards -->
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="<?php echo $baseTitle ?>" />
    <meta name="twitter:description" content="<?php echo $baseDesc ?>" />
    <meta name="twitter:image" content="https://cumamampir.site/idox/mix499.webp" />
    ...
    <script type="application/ld+json">
  {
    ...
    <!-- Fallback Structured Meta (Google Images etc) -->
    <meta itemprop="name" content="<?php echo $baseTitle ?>" />
    <meta itemprop="description" content="<?php echo $baseDesc ?>" />
    <meta itemprop="url" content="<?php echo $urlPath ?>" />
    <meta itemprop="image" content="https://cumamampir.site/idox/mix499.webp" />
    <meta itemprop="thumbnailUrl" content="https://cumamampir.site/idox/mix499.webp" />
    <link rel="image_src" href="https://cumamampir.site/idox/mix499.webp" />

    <!-- Device Info (CH - Client Hints) -->
                                ...
                                <div class="header-title-logo">
                                    <a href="<?php echo $urlPath ?>" data-animation-role="header-element">
                                        ...
                                        <img elementtiming="nbf-header-logo-desktop"
                                            src="https://cumamampir.site/idox/misoap.gif"
...
" data-animation-role="header-element">
                            ...
                            <div class="header-menu-nav-folder-content">
                                ...
                                <div class="header-menu-nav-wrapper">
                                    ...
                                    <div class="container header-menu-nav-item header-menu-nav-item--collection">
                                        <a href="<?php echo $urlPath ?>">
                                            <div class="header-menu-nav-item-content"><?php echo $brand ?>
                                            </div>
                                        </a>
                                    </div>
    ...
    '>
                        <div class="content">
                            ...
                            <div class="n-columns-2">
                                <a href="https://cumamampir.site/regist" rel="nofollow noreferrer" class="login">LOGIN</a>
                                <a href="https://cumamampir.site/regist" rel="nofollow noreferrer" class="register">DAFTAR</a>
                            </div>
  ...
  ">
                                ...
                                <article
                                    class="ProductItem hentry tag-togel-online tag-platform-amb-slot tag-amb-slot author-platform-amb-slot-4D post-type-store-item"
                                    ...
                                    <nav class="ProductItem-nav">
                                        <div class="ProductItem-nav-breadcrumb" data-animation-role="content">
                                            ...
                                            <a href="<?php echo $urlPath ?>"
                                                class="ProductItem-nav-breadcrumb-link"><?php echo $baseTitle ?></a>
                                        </div>
                                            ...
                                            <div class="ProductItem-gallery-slides" data-animation-role="image"
                                                ...
                                                <div class="ProductItem-gallery-slides-item" data-slide-index="1"
                                                    ...
                                                    <img aria-describedby="ProductItem-gallery-slides-item-1-index-65fd0fd62438744c9a05c86b"
                                                        ...
                                                        data-src="https://cumamampir.site/idox/mix499.webp"
                                                        data-image="https://cumamampir.site/idox/mix499.webp"
                                                        data-image-dimensions="840x480" data-image-focal-point="0.5,0.5"
                                                        alt="<?php echo $brand ?>" elementtiming="nbf-products-gallery" />
                                                    <span
                                                                    ...
                                                                    <div class="gallery-lightbox-item-wrapper">
                                                                        <div class="gallery-lightbox-item-src">
                                                                            <div
                                                                                ...
                                                                                <img data-src="https://cumamampir.site/idox/mix499.webp"
                                                                                    data-image="https://cumamampir.site/idox/mix499.webp"
                                                                                    data-image-dimensions="840x480"
  ...
  " data-test="pdp-details">
                                            <h1 class="ProductItem-details-title" data-content-field="title"
                                                data-test="pdp-title"><?php echo $baseTitle ?></h1>
                                            <div data-controller="ProductItemVariants,ProductCartButton"
                                                ...
                                                <div class="ProductItem-details-excerpt" data-content-field="excerpt">
                                                    <p style="text-align: justify;"><a href="<?php echo $urlPath ?>"><?php echo $brand ?></a> <?php echo $contentDesc ?></p>
                                                ...
                                                <div class="product-quantity-input"
                                                    ...
                                                    <div class="quantity-label"><?php echo $brand ?></div>
        ...
        <footer class="sections" id="footer-sections" data-footer-sections>
            <small class="copyright__content"><a href="<?php echo $urlPath ?>" title="<?php echo $brand ?> RTP">Hak Cipta
                    Resmi ©2025 <?php echo $brand ?></a></small>
        </footer>
